...
@app.post("/master/{master_id}/sign_master_key", tags=["master"])
@doc_fix
async def sign_master_key(master_id: int, mok: KEY):
    """
    Функция подписывания одного мастер ключа
    другим мастер-ключом.
    """
